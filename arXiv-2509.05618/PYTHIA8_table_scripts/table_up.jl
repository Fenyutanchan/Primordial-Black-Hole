...
@everywhere pythia = begin
    ...
    PYTHIA8.readString(pythia, "WeakSingleBoson:ffbar2ffbar(s:gmZ) = on")
    PYTHIA8.readString(pythia, "PartonLevel:ISR = off")
    PYTHIA8.readString(pythia, "23:onMode = off")
    PYTHIA8.readString(pythia, "23:onIfAny = 2")
